...
/**
 * Minimal 2D drawing surface used by games. Narrowed from
 * `CanvasRenderingContext2D` so tests can pass a lightweight stub without
 * the full canvas API. Real canvases satisfy this interface structurally.
 */
